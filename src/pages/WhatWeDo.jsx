    ...
    <div className="pt-20">
      ...
      <section className="relative h-[50vh] flex items-center justify-center text-white">
        <div 
          ...
          style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1559304822-9eb2813c9844?q=80&w=2574&auto=format&fit=crop")' }}
        >
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-xl text-cyan-100">Excellence in every step of the process.</p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-slate-600 text-lg mb-6">
                Our farming practices are rooted in sustainability and innovation. We utilize chemical-free cultivation methods 
                to ensure the health of our shrimp and the environment.
              </p>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-center text-slate-700">
                    <CheckCircle className="text-cyan-500 mr-3 shrink-0" size={20} />
                    {item}
                  </li>
                ))}
              </ul>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            ...
            >
              ...
              <p className="text-slate-600 text-lg mb-6">
                We deliver premium quality shrimp directly from our ponds to the global market. 
                Our commitment to traceability ensures that our customers know exactly where their food comes from.
              </p>
              <ul className="space-y-4">
                {[
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-2xl font-bold text-slate-400 mb-12 uppercase tracking-widest">Trusted Logistics Partner</h2>
          <div className="flex justify-center items-center grayscale hover:grayscale-0 transition-all duration-500 opacity-70 hover:opacity-100">
            ...
            <div className="flex items-center gap-4">
               ...
               <span className="text-4xl font-black text-blue-900 tracking-tighter">MAERSK</span>
            </div>
          </div>
        </div>
      </section>
