      ...
      <section className="relative h-[50vh] flex items-center justify-center text-white">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-xl text-cyan-100">
            Cultivating the future of sustainable aquaculture.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-6">
              Founded in 2022, Terraqua began with a vision to transform the
              shrimp farming landscape in Indonesia. Located in the pristine
              waters of Membalong, Belitung, we recognized the immense potential
              of the region for high-quality aquaculture.
            </p>
            <p className="text-slate-600 text-lg leading-relaxed">
              From our humble beginnings, we have grown into a leader in
              sustainable practices, driven by a passion for excellence and a
              deep respect for the environment. Our journey is one of continuous
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 mt-4">
              Driven by four core pillars of excellence.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <p className="text-slate-600 text-lg mb-6">
                Strategically located in Membalong, Belitung Island. The region
                offers pristine water quality and ideal climate conditions for
                shrimp farming, allowing us to produce premium quality harvest
                year-round.
              </p>
